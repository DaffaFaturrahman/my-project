...
#define BOTtoken "1224230939:AAH9Leq1VXo34S8a7FHahvuTOxhm7WRdZFI"  
...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i=0; i<numNewMessages; i++) {
    String pesan = String(bot.messages[i].pesan);
    ...
    if (text == "/nyalainlampu1") {
      ...
      bot.sendMessage(pesan, "Lampu1 nyala", "");
    }

    if (text == "/matiinlampu1") {
      kondisilampu1 = 0;
      digitalWrite(relay1, 0);    
      bot.sendMessage(pesan, "Lampu1 mati", "");
    }

    if (text == "/kondisilampu1") {
      if(kondisilampu1){
        bot.sendMessage(pesan, "Lampu1 menyala", "");
      } else {
        bot.sendMessage(pesan, "Lampu1 mati", "");
      }
    }
    ...
    if (text == "/matiinlampu2") {
      kondisilampu2 = 0;
      digitalWrite(relay2, 0);    
      bot.sendMessage(pesan, "Lampu2 mati", "");
    }

    if (text == "/kondisilampu2") {
      if(kondisilampu2){
        bot.sendMessage(pesan, "Lampu2 menyala", "");
      } else {
        bot.sendMessage(pesan, "Lampu2 mati", "");
      }
    }
    if (text == "/nyalainlampu3") {
      ...
      bot.sendMessage(pesan, "Lampu3 nyala", "");
    }

    if (text == "/matiinlampu3") {
      kondisilampu3 = 0;
      digitalWrite(relay3, 0);    
      bot.sendMessage(pesan, "Lampu3 mati", "");
    }

    if (text == "/kondisilampu3") {
      if(kondisilampu3){
        bot.sendMessage(pesan, "Lampu3 menyala", "");
      } else {
        bot.sendMessage(pesan, "Lampu3 mati", "");
      }
    }
    if (text == "/nyalainsemualampu") {
      ...
      digitalWrite(relay2, 1);
      digitalWrite(relay3, 1);
      bot.sendMessage(pesan, "Semua Lampu Menyala", "");
    }
    ...
    if (text == "/matiinsemualampu") {
      ...
      digitalWrite(relay2, 0);
      digitalWrite(relay3, 0);
      bot.sendMessage(pesan, "Semua Lampu Mati", "");  
    ...
    if (text == "/start") {
      ...
      welcome += "/kondisilampu12 : untuk mengecek keadaan lampu2\n";
      
      welcome += "/nyalainlampu3 : untuk manyalakan lampu3\n";
      welcome += "/matiinlampu3 : untuk mematikan lampu3\n";
      welcome += "/kondisilampu13 : untuk mengecek keadaan lampu3\n";
